...
describe('configuration mAI', () => {
  ...
  it('utilise le même identifiant natif sur les cinq plateformes', () => {
    ...
    expect(readFileSync('android/app/build.gradle', 'utf8')).toContain('applicationId "com.mai.app"');
    expect(readFileSync('ios/App/App.xcodeproj/project.pbxproj', 'utf8')).toContain('PRODUCT_BUNDLE_IDENTIFIER = com.mai.app;');
  });
