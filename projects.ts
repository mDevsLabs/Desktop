...
export const STATIC_PROJECTS_LIST = [
  ...
  },
  {
    ...
    features: ['Terminal interactif', 'Génération de code', 'Workflows développeur'],
    id: 'proj_cli',
    is_public: true,
    label: 'Bêta',
    name: 'CLI',
  ...
  },
  {
    ...
    description: "Moteur de recherche sémantique et d'indexation vectorielle ultra-rapide.",
  ...
  },
  {
    ...
    description: "Hub universel d'agrégation et de routage intelligent d'API et modèles LLM.",
...
export const STATIC_PROJECTS_MAP: Record<string, any> = {
  ...
  maicli: {
    ...
    description: "Interface en ligne de commande professionnelle pour l'écosystème mAI.",
    is_public: true,
    label: 'Archivé',
    name: 'mAI CLI (Legacy)',
    project_id: 'maicli',
  ...
  openprovider: {
    category: 'API Gateway',
    created_at: '2026-03-01T00:00:00.000Z',
    description: "Hub universel d'agrégation et de routage d'API et modèles LLM.",
    is_public: true,
    label: 'Archivé',
    name: 'OpenProvider',
    project_id: 'openprovider',
